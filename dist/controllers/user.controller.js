...
export var getUser = function getUser(req, res) {
...
export var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res, next) {
    var userId, _req$body, oldPassword, newPassword, user, isMatch, _t2;
...
export var contactUs = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res, next) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 1:
          emitter.emit('User.contactus', _objectSpread({}, req.body));
          res.status(200).json({
  ...
  return function contactUs(_x7, _x8, _x9) {
